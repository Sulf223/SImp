<div data-component="dashboard-modern">
    <header class="dash__header">
        ...
        <h2 class="dash__title">Merge <span class="dash__title-accent">Sort</span></h2>
        <p class="dash__lede">
            Sortare prin interclasare. Utilizează strategia Divide et Impera.
            Complexitate: <strong>O(n log n)</strong>.
        </p>
    </header>
    ...
    <div class="bento">
        <div class="card bento__card--hero">
            ...
            <div class="card__body">
                <pre style="background: var(--color-surface-2); padding: var(--space-4); border-radius: var(--radius-md); overflow-x: auto;"><code>void mergeSort(int a[], int st, int dr) {
    if (st >= dr) return;
    int mid = (st + dr) / 2;
    mergeSort(a, st, mid);
    ...
    merge(a, st, mid, dr);
        ...
        <div class="card bento__card--accent">
            ...
            <div id="sorting-visualizer" class="visualizer-container" data-algorithm="merge" style="min-height: 250px; background: var(--color-surface-2); border-radius: var(--radius-lg);"></div>
