            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid var(--color-border);">
                    ...
                    <td style="padding: 0.75rem; text-align:center;">
                        ...
                        <?php else: ?>
                        <form method="post" action="PHP/admin_actions.php" style="display:inline;" data-confirm="Schimbă rolul utilizatorului selectat?">
                            <?php csrf_field(); ?>
                    ...
                    <td style="padding: 0.75rem; text-align:center;">
                        <form method="post" action="PHP/admin_actions.php" style="display:inline;" data-confirm="Resetează TOT progresul pentru utilizatorul selectat? Această acțiune este ireversibilă.">
                            <?php csrf_field(); ?>
                    ...
                    <td style="padding: 0.75rem; text-align:center;">
                        <?php if ($is_self): ?>
                            <span style="color: var(--color-fg-muted); font-size: var(--text-xs);">— (cont propriu)</span>
                        <?php else: ?>
                        <form method="post" action="PHP/admin_actions.php" style="display:inline;" data-confirm="Șterge definitiv contul selectat? Această acțiune NU poate fi anulată.">
                            <?php csrf_field(); ?>
