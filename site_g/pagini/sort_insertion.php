<div data-component="dashboard-modern">
    <header class="dash__header">
        ...
        <h2 class="dash__title">Insertion <span class="dash__title-accent">Sort</span></h2>
        <p class="dash__lede">
            Sortare prin inserție. Eficientă pe vectori mici sau aproape sortați.
    ...
    <div class="bento">
        <div class="card bento__card--hero">
            ...
            <div class="card__body">
                <pre style="background: var(--color-surface-2); padding: var(--space-4); border-radius: var(--radius-md); overflow-x: auto;"><code>for (int i = 1; i < n; i++) {
    int key = v[i], j = i - 1;
    while (j >= 0 && v[j] > key) {
        v[j + 1] = v[j];
        j--;
    ...
    v[j + 1] = key;
        ...
        <div class="card bento__card--accent">
            ...
            <div id="sorting-visualizer" class="visualizer-container" data-algorithm="insertion" style="min-height: 250px; background: var(--color-surface-2); border-radius: var(--radius-lg);"></div>
