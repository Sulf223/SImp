...
$lesson = [
    ...
    'pseudocode' => [
        ['line' => 1, 'text' => 'copiază jumătatea stângă în left'],
        ['line' => 2, 'text' => 'copiază jumătatea dreaptă în right'],
        ['line' => 3, 'text' => 'cât timp ambele jumătăți mai au elemente'],
        ['line' => 4, 'text' => '  dacă left[i] <= right[j], scrie left[i]'],
        ['line' => 5, 'text' => '  altfel scrie right[j]'],
    ],
    'variables' => [
        'lo' => 'începutul intervalului',
        'mid' => 'mijlocul intervalului',
        'hi' => 'finalul intervalului',
        'i' => 'poziția în jumătatea stângă',
        'j' => 'poziția în jumătatea dreaptă',
