...
<div data-component="dashboard-modern">
    ...
    <div class="bento">
        <article class="card bento__card--stat">
            ...
            <h3 class="card__title-sm">Recursivitate</h3>
            <p class="card__body">
        ...
        <article class="card bento__card--stat">
            ...
            <h3 class="card__title-sm">Backtracking</h3>
            <p class="card__body">
        ...
        <article class="card bento__card--stat">
            ...
            <h3 class="card__title-sm">Greedy</h3>
            <p class="card__body">
        ...
        <article class="card bento__card--stat">
            ...
            <h3 class="card__title-sm">Divide et Impera</h3>
            <p class="card__body">
