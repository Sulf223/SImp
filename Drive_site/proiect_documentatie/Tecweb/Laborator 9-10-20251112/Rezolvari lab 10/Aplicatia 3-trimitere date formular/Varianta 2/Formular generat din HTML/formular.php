...
?>
<form action="formular.php" method="post" name="form1" id="form1" >

  <p>
    Nume: 
    <input type="text" name="nume" value="<?php echo $_POST['nume']; ?>" > 
    <br>
    Prenume: 
  <input type="text" name="prenume" value="<?php echo $_POST['prenume']; ?>" > 
  </p>
  <p>Email 
    <input type="text" name="email" value="<?php echo $_POST['email']; ?>" >
    <br>
    Varsta: 
    <input type="text" name="varsta" value="<?php echo $_POST['varsta']; ?>" id="varsta"> 
    <br>
    Comentariu: 
